...
# == Camera Feed Input ==
cap1 = "E:\StockVision\extended_dataset_v1\images\test\IMG_1458_JPG.rf.565a7d2e719e967195221ce40887df8a.jpg" #cv2.VideoCapture(0)
cap2 = "E:\StockVision\extended_dataset_v1\images\test\IMG_1486_JPG.rf.4d7a6886804011814565a5865cd29e1f.jpg" #cv2.VideoCapture(1)
...
while True:
    ...
    results1 = model(frame2, imgsz=imagesize, conf=confidence)[0]
